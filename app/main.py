...
from app.api.routes import auth_router, chat_router, embed_router, mcp_router, mcp_oauth_router
...
app.include_router(mcp_oauth_router.router)  # OAuth 2.1 + PKCE for Claude.ai MCP
